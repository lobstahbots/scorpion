 ...
 * PIDOutput
 */
public class V4BPIDController implements LiveWindowSendable{
    ...
    public V4BPIDController previousJoint;
    ...
    private class PIDTask extends TimerTask {
        ...
        private V4BPIDController m_controller;

        public PIDTask(V4BPIDController controller) {
            if (controller == null) {
     ...
     */
    public V4BPIDController(double Kp, double Ki, double Kd, double Kf,
                         PIDSource source, PIDOutput output,
                         double period, V4BPIDController previousJoint) {
     ...
     * integral and differential terms. The default is 50ms.
     */
    public V4BPIDController(double Kp, double Ki, double Kd,
                         PIDSource source, PIDOutput output,
                         double period, V4BPIDController previousJoint) {
        this(Kp, Ki, Kd, 0.0, source, output, period, previousJoint);
    }
     ...
     */
    public V4BPIDController(double Kp, double Ki, double Kd,
                         PIDSource source, PIDOutput output, V4BPIDController previousJoint) {
        this(Kp, Ki, Kd, source, output, kDefaultPeriod, previousJoint);
    }
    ...
    public V4BPIDController(double Kp, double Ki, double Kd, double Kf,
                         PIDSource source, PIDOutput output, V4BPIDController previousJoint) {
        this(Kp, Ki, Kd, Kf, source, output, kDefaultPeriod, previousJoint);
    }
